...
import { FiUsers, FiBarChart2, FiSettings, FiFileText, FiBell, FiSearch, FiHome, FiLogOut, FiFolder } from 'react-icons/fi';
...
const AdminDashboard = ({ 
  ...
  const stats = [
    { id: 'users', title: 'Total Users', value: '124', icon: FiUsers, color: 'bg-blue-500' },
    { id: 'cases', title: 'Active Cases', value: '87', icon: FiFileText, color: 'bg-green-500' },
    { id: 'alerts', title: 'Alerts', value: '5', icon: FiBell, color: 'bg-red-500' },
    { id: 'reports', title: 'Reports', value: '36', icon: FiBarChart2, color: 'bg-purple-500' },
  ];
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      >
        <div className={`flex items-center justify-center h-16 border-b ${isSidebarHovered ? 'px-4' : 'px-0'}`}>
          {isSidebarHovered ? (
            <h1 className="text-xl font-bold text-primary-700">Admin Dashboard</h1>
          ) : (
            <FiHome className="text-xl text-primary-700" />
          )}
        </div>
        <div className="p-2">
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                  {stats.map((stat) => {
                    ...
                    return (
                      <div key={stat.id} className="bg-white p-6 rounded-16px shadow-sm">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-white rounded-lg shadow-sm p-3">
                        <div className="flex justify-between items-start">
                          <div>
                            <div className="bg-blue-500 text-white text-xs px-2 py-1 rounded-sm inline-block mb-1">VICTIM STATEMENT</div>
                            <h3 className="font-medium text-sm">John Linden</h3>
                            <p className="text-xs text-gray-500">Case #CRI12145/21</p>
                            <p className="text-xs text-gray-500">Officer: DC S. Morgan</p>
                          </div>
                          <div className="text-right">
                            <div className="font-bold text-sm">15/04/2023</div>
                            <div className="text-blue-600 text-xs">14:30</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-lg shadow-sm p-3">
                        <div className="flex justify-between items-start">
                          <div>
                            <div className="bg-green-500 text-white text-xs px-2 py-1 rounded-sm inline-block mb-1">CASE REVIEW</div>
                            <h3 className="font-medium text-sm">Aidan Shah</h3>
                            <p className="text-xs text-gray-500">Case #CRI12366/21</p>
                            <p className="text-xs text-gray-500">Officer: DC T. Wilson</p>
                          </div>
                          <div className="text-right">
                            <div className="font-bold text-sm">16/04/2023</div>
                            <div className="text-blue-600 text-xs">10:15</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-lg shadow-sm p-3">
                        <div className="flex justify-between items-start">
                          <div>
                            <div className="bg-purple-500 text-white text-xs px-2 py-1 rounded-sm inline-block mb-1">EVIDENCE REVIEW</div>
                            <h3 className="font-medium text-sm">Sarah Johnson</h3>
                            <p className="text-xs text-gray-500">Case #CRI10987/23</p>
                            <p className="text-xs text-gray-500">Officer: DC R. Peters</p>
                          </div>
                          <div className="text-right">
                            <div className="font-bold text-sm">17/04/2023</div>
                            <div className="text-blue-600 text-xs">09:00</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-lg shadow-sm p-3">
                        <div className="flex justify-between items-start">
                          <div>
                            <div className="bg-red-500 text-white text-xs px-2 py-1 rounded-sm inline-block mb-1">COURT PREPARATION</div>
                            <h3 className="font-medium text-sm">Michael Chen</h3>
                            <p className="text-xs text-gray-500">Case #CRI11245/23</p>
                            <p className="text-xs text-gray-500">Officer: DC S. Morgan</p>
                          </div>
                          <div className="text-right">
                            <div className="font-bold text-sm">18/04/2023</div>
                            <div className="text-blue-600 text-xs">13:00</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-lg shadow-sm p-3">
                        <div className="flex justify-between items-start">
                          <div>
                            <div className="bg-yellow-500 text-white text-xs px-2 py-1 rounded-sm inline-block mb-1">WITNESS INTERVIEW</div>
                            <h3 className="font-medium text-sm">Emma Roberts</h3>
                            <p className="text-xs text-gray-500">Case #CRI12789/23</p>
                            <p className="text-xs text-gray-500">Officer: DC L. Johnson</p>
                          </div>
                          <div className="text-right">
                            <div className="font-bold text-sm">20/04/2023</div>
                            <div className="text-blue-600 text-xs">15:45</div>
                          </div>
                        </div>
                      </div>
                    </div>
